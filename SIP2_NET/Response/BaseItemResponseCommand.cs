...
{
    public abstract class BaseItemResponseCommand: BaseResponseCommand
    {

        public BaseItemResponseCommand():base(){ }

        public BaseItemResponseCommand(string command):base(command)  { }
